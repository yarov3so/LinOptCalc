...
iframe_code="""<iframe src="https://trinket.io/embed/python3/a57e81eabcb8?outputOnly=true&runOption=run&start=result" width="100%" height="400px" frameborder="0" marginwidth="0" marginheight="0" allowfullscreen></iframe>"""
