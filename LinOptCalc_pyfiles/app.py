...
iframe_code="""<iframe src="https://trinket.io/embed/python3/dbf60d5f9ede?outputOnly=true&runOption=run&start=result" width="100%" height="1000px" frameborder="0" marginwidth="0" marginheight="0" allowfullscreen></iframe>"""
